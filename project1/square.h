...
private:
    ...
    QIcon revealedIcon = QIcon(QPixmap("/home/raspberry/Desktop/minesweeper/project/pictures/blank.png").scaled(QSize(20, 20)));
    QIcon flagIcon = QIcon(QPixmap("/home/raspberry/Desktop/minesweeper/project/pictures/flag.png").scaled(QSize(20, 20)));
    QIcon mineIcon = QIcon(QPixmap("/home/raspberry/Desktop/minesweeper/project/pictures/mine.png").scaled(QSize(20, 20)));
