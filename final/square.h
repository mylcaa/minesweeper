...
private:
    ...
    QIcon revealedIcon = QIcon(QPixmap("/home/raspberry/Desktop/minesweeper/minesweeper/bla/pictures/blank.png").scaled(QSize(20, 20)));
    QIcon flagIcon = QIcon(QPixmap("/home/raspberry/Desktop/minesweeper/minesweeper/bla/pictures/flag.png").scaled(QSize(20, 20)));
    QIcon mineIcon = QIcon(QPixmap("/home/raspberry/Desktop/minesweeper/minesweeper/bla/pictures/mine.png").scaled(QSize(20, 20)));
