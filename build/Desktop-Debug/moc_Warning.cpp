...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_warning_window_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject warning_window::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_warning_window.data,
    qt_meta_data_warning_window,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *warning_window::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_warning_window.stringdata0))
